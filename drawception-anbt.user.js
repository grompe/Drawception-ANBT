...
var SCRIPT_VERSION = "1.113.2017.6";
var NEWCANVAS_VERSION = 33; // Increase to update the cached canvas
var SITE_VERSION = "2.6.5"; // Last seen site version
...
function pageEnhancements()
{
  ...
  $(".footer-main .list-unstyled").eq(2).append('<li><a href="http://chat.grompe.org.ru/#drawception">Chat</a> (<a href="https://discord.gg/7cPD7hC">Discord</a>)</li>');
...
localStorage.setItem("gpe_darkCSS",
  ...
  ".drawingForm{~#555$}.well{~#666$;border:1px solid #333$}#timeleft{color:#AAA$}legend{border-bottom:1px solid #000$}.thumbpanel-text{~#555$}.thumbpanel img{~#fffdc9$}.panel-number,.modal-content,.profile-user-header{~#555$}" +
